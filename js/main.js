...
*/
//'imgs/insta.png'
var mat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture(path)});
...
var bodyMat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture('imgs/money.png')});
...
var bodyMat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture('imgs/like.png')});
var body = new THREE.Mesh(body, bodyMat);
...
this.mesh.name = "love";
var body = new THREE.BoxGeometry(15,15,15);
var bodyMat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture('imgs/love.png')});
var body = new THREE.Mesh(body, bodyMat);
body.position.set(32,-12,0);
this.mesh.add(body);
}
...
this.mesh.name = "shop";
var body = new THREE.BoxGeometry(15,15,15);
var bodyMat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture('imgs/download.png')});
var body = new THREE.Mesh(body, bodyMat);
body.position.set(32,-12,0);
this.mesh.add(body);
}
...
var body = new THREE.BoxGeometry(15,15,15);
var bodyMat = new THREE.MeshBasicMaterial({map:THREE.ImageUtils.	loadTexture('imgs/gsearch.png')});
var body = new THREE.Mesh(body, bodyMat);
body.position.set(32,-12,0);
this.mesh.add(body);
}
